      ...
      <div className="max-w-6xl mx-auto w-full">
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-xs font-bold uppercase tracking-widest text-secondary border border-secondary/30 px-3 py-1 rounded-full liquid-glass bg-secondary/10">Character Profile</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 auto-rows-auto">
          ...
          >
            <div className="flex items-center gap-3 mb-8">
              ...
              <h3 className="text-lg font-bold text-foreground uppercase tracking-wider">Badges & Achievements</h3>
            </div>
